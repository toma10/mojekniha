...
class UserTest extends TestCase
{
    ...
    {
        $user = factory(\App\Domain\User\Models\User::class)->create(['email' => 'johndoe@example.com']);
    ...
    {
        $user = factory(\App\Domain\User\Models\User::class)->make(['email' => 'johndoe@example.com']);
    ...
    {
        $user = factory(\App\Domain\User\Models\User::class)->create(['is_admin' => false]);
        $admin = factory(\App\Domain\User\Models\User::class)->create(['is_admin' => true]);
    ...
    {
        $unverifiedUser = factory(\App\Domain\User\Models\User::class)->create(['email_verified_at' => null]);
        $verifiedUser = factory(\App\Domain\User\Models\User::class)->create(['email_verified_at' => now()]);
