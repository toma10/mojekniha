...
class UpdateAuthorTest extends InertiaTestCase
{
    use RefreshDatabase;
    ...
    public function user_must_be_admin()
    {
        ...
        $this->get("admin/books/authors/{$author->id}/edit")
            ->assertRedirect();

        $this->actingAs($user, 'web')->get("admin/books/authors/{$author->id}/edit")
            ->assertRedirect();
    }
    ...
    public function viewing_edit_page()
    {
        ...
        $response = $this->actingAs($admin, 'web')->get("admin/books/authors/{$author->id}/edit");
        ...
        $response
            ...
            ->assertPropCount('nationalities', 4);
    }
    ...
    public function it_updates_the_author()
    {
        ...
        $response = $this->actingAs($admin, 'web')->put("admin/books/authors/{$author->id}", $data);

        $response
            ->assertRedirect("admin/books/authors/{$author->id}/edit")
