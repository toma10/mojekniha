...
class UpdateEditionTest extends InertiaTestCase
{
    use RefreshDatabase;
    ...
    public function user_must_be_admin()
    {
        ...
        $this->get("admin/books/editions/{$edition->id}/edit")
            ->assertRedirect();

        $this->actingAs($user, 'web')->get("admin/books/editions/{$edition->id}/edit")
            ->assertRedirect();
    }
    ...
    public function viewing_edit_page()
    {
        ...
        $response = $this->actingAs($admin, 'web')->get("admin/books/editions/{$edition->id}/edit");
        ...
        $response
            ...
            ->assertPropCount('books', 4)
            ->assertPropCount('languages', 5)
            ->assertPropCount('bookBindings', 3);
    }
    ...
    public function it_updates_the_edition()
    {
        ...
        $response = $this->actingAs($admin, 'web')->put("admin/books/editions/{$edition->id}", $data);

        $response
            ->assertRedirect("admin/books/editions/{$edition->id}/edit")
